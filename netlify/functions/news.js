...
const RSS_FEEDS = [
  ...
  // LEVANT THEATRE — Lebanon / Gaza / Israel sub-clusters
  { id: "lorient_today", url: "https://today.lorientlejour.com/feed",                          name: "L'Orient Today",    cat: "regional", max: 5 },
  { id: "naharnet",      url: "https://www.naharnet.com/rss.xml",                              name: "Naharnet",          cat: "regional", max: 4 },
  { id: "alakhbar_lb",   url: "https://al-akhbar.com/rss.xml",                                 name: "Al-Akhbar",         cat: "regional", max: 4 },
  { id: "toi_north",     url: "https://www.timesofisrael.com/topic/northern-front/feed/",      name: "ToI Northern",      cat: "regional", max: 5 },
  { id: "almanar",       url: "https://english.almanar.com.lb/feed",                           name: "Al-Manar",          cat: "regional", max: 3 },
  { id: "unifil",        url: "https://unifil.unmissions.org/news/feed",                       name: "UNIFIL Press",      cat: "regional", max: 6 },
  { id: "aljazeera_ar",  url: "https://www.aljazeera.net/feed/rss2",                           name: "Al Jazeera Arabic", cat: "regional", max: 5 },
  { id: "ocha_opt",      url: "https://www.ochaopt.org/rss.xml",                               name: "OCHA OPT",          cat: "regional", max: 6 },
  { id: "unrwa",         url: "https://www.unrwa.org/newsroom/rss.xml",                        name: "UNRWA",             cat: "regional", max: 5 },
  { id: "euromed",       url: "https://euromedmonitor.org/en/feed",                            name: "Euro-Med Monitor",  cat: "regional", max: 4 },
  { id: "ynet",          url: "https://www.ynetnews.com/RSS/",                                 name: "Ynet English",      cat: "regional", max: 4 },
  { id: "jpost",         url: "https://www.jpost.com/rss/rssfeedsfrontpage.aspx",              name: "Jerusalem Post",    cat: "regional", max: 4 },
  { id: "haaretz",       url: "https://www.haaretz.com/cmlink/1.4565867",                      name: "Haaretz",           cat: "regional", max: 5 },
  { id: "idf",           url: "https://www.idf.il/en/mini-sites/press-releases/rss/",          name: "IDF Spokesperson",  cat: "regional", max: 5 },
