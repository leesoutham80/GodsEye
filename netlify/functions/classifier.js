...
const CLASSIFIER_FRAMEWORK = {
  ...
  force_posture: {
    signals: ["S1b","S1c","S23","S27","S75","S126"],
    tier1: ["carrier group","battle group","naval presence","forward deployed","theatre assets","readiness level","force generation","royal navy","RAF","akrotiri","UKMTO","UK maritime"],
    tier2: ["reinforcement","surge","deployment order","reserve activation","mobilisation order","conscription","draft","additional forces","troop buildup","force posture change","DEFCON","alert level raised","warship deployment","frigate","destroyer","type 45","type 26"],
    tier3: ["carrier strike group","amphibious ready group","marine expeditionary","special operations","SEAL","SOF","pararescue","combat search and rescue","CSAR","force projection","power projection","theatre command","CENTCOM","EUCOM","INDOPACOM","HMS","escort mission","maritime patrol"],
  ...
  diplomatic: {
    signals: ["S4","S5","S10","S19","S20","S26","S29","S30","S123","S125","S127","S129","S130","S131"],
    ...
    tier2: ["sanction","trade restriction","export control","asset freeze","travel ban","designation","UN vote","security council","resolution","veto","abstention","General Assembly","envoy","ambassador recalled","diplomatic protest","mandelson","ambassador","UK foreign secretary","UK prime minister","starmer","PMQs","commons","parliament","farage","downing street"],
    tier3: ["summit","leaders meet","state visit","foreign minister","secretary of state","joint statement","memorandum","framework agreement","roadmap","timeline","conditions","demands","ultimatum","red line","deadline","Qatar","al jazeera","doha","mediation","mediator","back channel","islamabad talks","pakistan mediation","CENTCOM statement","US envoy","royal family","king charles","prince william","buckingham palace","windsor","crown","monarchy"],
    tier4: ["alliance formed","coalition","joint military","mutual defence","treaty","pact","accord","landmark agreement","normalisation","recognition","embassy opened","relations restored","axis","bloc","andrew epstein","royal scandal","leverage","blackmail"],
  ...
  information: {
    signals: ["S88","S99","S100","S124"],
    tier1: ["social media","trending","viral","hashtag","influencer","content creator","commentary","opinion"],
    tier2: ["disinformation","misinformation","propaganda","fake news","deepfake","bot","troll farm","psyop","information operation","narrative warfare","spin","framing","tasnim","fars news","press tv","iranian media","IRGC media"],
    tier3: ["media blackout","internet shutdown","communications cut","OSINT","open source intelligence","satellite imagery","leaked","classified","whistleblower","censorship","press freedom","supreme leader","ayatollah","khamenei","mojtaba khamenei","honorific","commander of the faithful","representative of the imam","defender of the revolution"],
  ...
  // ═══ CYBER ═══
  cyber: {
    signals: ["S78","S87","S64","S128"],
    tier1: ["cyber","hack","breach","vulnerability","patch","update","security advisory"],
    tier2: ["cyber attack","DDoS","ransomware","phishing","malware","data breach","credentials leaked","zero day","exploit","APT","advanced persistent threat","subsea cable","fiber optic","internet cable"],
    tier3: ["critical infrastructure hack","SCADA","industrial control","port system hack","AIS spoofing","GPS jamming","GPS spoofing","communications disrupted","satellite hack","subsea cable","fibre optic cut","cable cut","cable mapping","TeleGeography","landing station","sea-me-we","AAE-1","FALCON cable","TGN-Gulf"],
    tier4: ["power grid attack","financial system hack","SWIFT attack","nuclear facility cyber","military system compromised","command and control disrupted","stuxnet","wiper malware","cable sabotage","cable threat","subsea infrastructure"],
